...
public class TC01_Add_Skills_Parameters2 {
	...
	//if u want to execute u r test with multiple input test data , we can user Data Provider
	 ...
	 //Step1 - Copy Data Provider syntax and should ready with my test data
  ...
  @Test(dataProvider="Orange1")//Step2 Connected with data provider
  public void SkillsTest(String TestURL,String UserName,
		  String Password,String SkillName,String SkillDescr) throws Exception {
	  
	  TC01_Add_Skills_Parameters2 T1= new TC01_Add_Skills_Parameters2();
